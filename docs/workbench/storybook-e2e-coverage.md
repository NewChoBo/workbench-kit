...
| `Atomic UI/Overlays/Dialog Actions` - Context menu pointer state    | Main-area trigger with fixed overlay          | `useContextMenuState` opens a menu from right-click coordinates, closes after select, and restores the connected invoker after Escape                                                                                     |
