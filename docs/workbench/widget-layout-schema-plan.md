...
| Preview                              | `renderJdw`, `JdwPreview`, CSS layout backend           | Canvas preview selection and hover chrome are wired; `listen` invalidation candidates are value-diff driven; scheduler deferred                                                                                                                                                                                                                                                                                                                                                      |
