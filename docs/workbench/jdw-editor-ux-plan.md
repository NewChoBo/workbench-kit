...
- **다음 권장:** **focus chrome / richer indicators** 또는 **per-parent schema specialization** — B1 root schema parity와 B3/B4 canvas resize/reparent/preview-drop/hover slices는 `WidgetTreeLab`/`@workbench-kit/jdw`에 연결됐다.
...
| --- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| P1  | **Preview chrome still shallow** — selected and hover frames exist, focus polish missing | `WidgetTreeCanvasPreview` overlays selected layout frames with drag/resize handles and transient hover frames; focus and scroll affordances remain minimal                                                                                                                                                                             | Low      |
...
| Preview chrome     | Click sets `WidgetSelectionState`; selected outline and transient hover frames exist; focus chrome remains |
...
| `JDW/WidgetTree/Lab/CanvasAuthoring`        | Lab harness      | focus chrome / richer authoring polish           | UX-5/B4  |
