...
- **다음 권장:** **richer indicators** — B1 root schema parity/per-parent schema refs와 B3/B4 canvas resize/reparent/preview-drop/hover/focus slices는 `WidgetTreeLab`/`@workbench-kit/jdw`에 연결됐다.
