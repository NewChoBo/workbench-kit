...
- **다음 권장:** Lane A S12 closeout은 완료. JDW에 남는다면 remaining outline edge polish 또는 preview zoom/pan 정책 결정을 좁은 slice로 진행한다.
...
| P9  | **Outline keyboard core wired**                             | Outline ArrowUp/Down/Home/End navigation, ArrowLeft/Right collapse/expand/parent-child navigation, Delete/Backspace remove, Alt+ArrowUp/Down move, and Enter→Props focus exist; Design/Code shortcut and richer view-toggle shortcuts remain                                                                                           | Low      |
...
| Keyboard    | Done for flattened outline ArrowUp/Down/Home/End, ArrowLeft/Right collapse/expand/parent-child navigation, Alt+ArrowUp/Down move, Delete/Backspace remove, and Enter focus props |
