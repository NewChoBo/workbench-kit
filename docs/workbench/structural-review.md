...
- **Lane A 갭:** WB-31 devtools inspectors landed (read-only registry/layout/editor/workspace snapshots + required Storybook coverage); current full validation is green, and next is S12 closeout audit.
