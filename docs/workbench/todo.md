...
| WB-29 | done     | P2       | Workspace  | Command-backed built-in explorer              | WB-24, WB-26, WB-27                 | `shell-react` explorer built-in, `@workbench-kit/workspace`                                             | Command handlers, UI dispatch, selection/reveal/search sync, targeted integration tests, and sample browser smoke are landed.                                                         |
