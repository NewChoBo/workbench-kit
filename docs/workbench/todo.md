...
| WB-28 | in-progress | P1       | Editor     | Editor contribution and service model         | WB-24, WB-25, WB-27                 | `@workbench-kit/workbench-core`, `@workbench-kit/workbench-react`, `@workbench-kit/workbench-extension-sdk` | S1–S3 done: tab chrome, `EditorArea`, builtin text editor, sample open-file, save via `WorkspaceResourceTransaction`; explorer open remains for WB-29. |
...
| 6     | WB-28       | Editor contribution and service model                         | **In progress (S3 done; explorer open deferred to WB-29)** |
