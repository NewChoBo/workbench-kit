...
| WB-29 | in-progress | P2       | Workspace  | Command-backed built-in explorer              | WB-24, WB-26, WB-27                 | `extensions/builtin.explorer`, `@workbench-kit/workspace`, `@workbench-kit/workbench-react`                 | Command handlers and UI dispatch for workspace create/open/copy/rename/delete/move are landed; closeout should verify selection/reveal/search behavior and sample smoke coverage.     |
...
| 7     | WB-29       | Command-backed built-in explorer                              | **In progress; handlers landed, closeout remains** |
