...
| WB-28 | done     | P1       | Editor     | Editor contribution and service model         | WB-24, WB-25, WB-27                 | `@workbench-kit/workbench-core`, `@workbench-kit/workbench-react`, `@workbench-kit/workbench-extension-sdk` | Tab chrome, `EditorArea`, builtin text editor, Code(JSON)/Form/Preview sample editing, and save via `WorkspaceResourceTransaction` are landed; explorer open/reveal remains in WB-29. |
| WB-29 | done     | P2       | Workspace  | Command-backed built-in explorer              | WB-24, WB-26, WB-27                 | `extensions/builtin.explorer`, `@workbench-kit/workspace`, `@workbench-kit/workbench-react`                 | Command handlers, UI dispatch, selection/reveal/search sync, and targeted integration tests are landed; manual sample smoke remains optional.                                         |
...
| WB-31 | done     | P3       | Devtools   | Registry and lifecycle inspectors             | WB-24, WB-26, WB-27                 | `@workbench-kit/workbench-react`                                                                            | Storybook devtools panel with registry snapshots and lifecycle inspectors.                                                                                                            |
