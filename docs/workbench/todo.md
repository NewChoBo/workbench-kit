...
| WB-23 | pending  | P0       | Harness    | Workbench sample host + launch boundary scope | Current staging baseline            | `examples/workbench-sample`, `scripts`                                                                      | Launch boundary check is now scoped to workbench-kit; restore a runnable frontend-only sample host next.                                              |
