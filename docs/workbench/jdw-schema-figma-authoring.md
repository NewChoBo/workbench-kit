...
| Canvas drag / resize → JDW              | **Partial**            | Selected stack/grid drag and stack 8-way resize commit JDW patches; reparent remains                        |
...
2. **React canvas gesture pipeline is partial** — selected stack/grid drag and stack 8-way resize commit JDW patches; reparent and grid drag/slot edge coverage remain.
...
4. **Phase 4 checklist incomplete** — outline DnD, asset materialization, the B2 headless mapping base, the B3 first canvas wire-in, stack resize, and grid column reflow are wired; reparent polish and broader layout-driven edge promotion remain.
...
| **B4**             | Drag reparent, resize, grid reflow, optional zoom/pan (Lane C overlap)               | Stack 8-way resize and grid columns reflow landed; reparent/grid drag edge remain |
