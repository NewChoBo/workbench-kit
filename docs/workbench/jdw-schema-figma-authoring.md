...
| Canvas drag / resize → JDW              | **Partial**            | Selected stack/grid drag, stack 8-way resize, canvas reparent, grid drag-slot reflow, grid resize span reflow, row/column linear resize, and wrapper-child resize commit JDW patches |
...
2. **React canvas gesture pipeline is partial** — selected stack/grid drag, stack 8-way resize, canvas reparent, grid drag-slot collision reflow, grid resize span reflow, row/column linear resize, and wrapper-child resize commit JDW patches; asset preview drop and richer drop indicators remain.
...
| **B4**             | Drag reparent, resize, grid reflow, optional zoom/pan (Lane C overlap)                                | Stack 8-way resize, grid columns reflow, canvas reparent, grid drag-slot reflow, grid resize span reflow, row/column linear resize, and wrapper-child resize landed |
