...
| **Storybook**    | *source only* until registered — see `packages/react/src/primitives/`  |
...
| Field            | Detail                                                                 |
| ---------------- | ---------------------------------------------------------------------- |
| **What you see** | Mapping editor for sample field-remap activity                         |
| **Sample / SB**  | Workbench Sample/Field Remap                                           |
| **Kit pieces**   | `@workbench-kit/field-remap` + sample extension host                   |
| **Host keeps**   | Persistence of mappings, schema sources                                |
