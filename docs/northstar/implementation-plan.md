...
This separation closes the 072A ownership dependency without claiming that the broader WB-NS-040 trust model is done.

### Required migration order

1. 072B adds canonical pack/theme/scope/provenance contracts in `contracts` and a pure focused registry/resolver in `workbench-core/design-system`; no DOM, React, JDW mutation or extension activation.
