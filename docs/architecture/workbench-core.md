...
Phase 2 implements the first headless host layer: extension registration and activation, menu/view/activity/config registries, layout state, bundled manifest exports, and configured extension resolution. Later phases connect this core to the React shell and built-in UI extensions.
...
- Built-in/sample manifests are generated by `scripts/bundle-workbench-extensions.mjs`.
