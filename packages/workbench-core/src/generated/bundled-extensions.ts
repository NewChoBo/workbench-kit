...
import * as samplesSchemaMapperModule from '../../../../extensions/samples.schema-mapper/src/index.ts';
...
export const SAMPLE_WORKBENCH_EXTENSIONS = [
  ...
  {
    extensionPath: 'extensions/samples.schema-mapper',
    manifest: {
      schemaVersion: 1,
      id: 'workbench-kit.samples.schema-mapper',
      name: 'samples-schema-mapper',
      ...
      activationEvents: ['onView:workbench-kit.samples.schema-mapper.panel'],
      contributes: {
        viewContainers: {
          activitybar: [
            {
        ...
        activities: [
          {
            id: 'workbench-kit.samples.schema-mapper.activity',
            viewContainerId: 'schemaMapper',
            icon: 'type-hierarchy',
            title: 'Field Remap',
            order: 36,
          },
        ...
        views: {
          schemaMapper: [
            {
              id: 'workbench-kit.samples.schema-mapper.panel',
              name: 'Field Remap',
            },
          ],
        },
        editors: [
          {
            id: 'workbench-kit.samples.schema-mapper.editor',
            label: 'Field Remap',
            icon: 'type-hierarchy',
          },
        ],
    ...
    module: samplesSchemaMapperModule,
  },
  {
