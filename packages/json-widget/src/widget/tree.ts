...
import type { ArrayChildWidget } from './child-ops.js';
import {
  getChildren,
  insertArrayChild,
  removeArrayChild,
 ...
 *
 * A `WidgetDocument` parses JDW source into this shape. Changes should be
 * expressed as `WidgetPatch` operations and serialized back to the same JDW
 * document rather than mirrored into a second editable hierarchy.
 */
