...
describe('WorkbenchProvider', () => {
  ...
  it('exposes theme selection through the settings appearance category', async () => {
    ...
    expect(dialog?.textContent).toContain(WORKBENCH_APPEARANCE_FIELD_LABELS.colorScheme);
    expect(dialog?.textContent).toContain(
      WORKBENCH_APPEARANCE_FIELD_LABELS.preferredLightColorTheme,
    );
    expect(dialog?.textContent).toContain(
    ...
    const colorSchemeCombobox = Array.from(
      ...
      (button) =>
        button.getAttribute('aria-label') === WORKBENCH_APPEARANCE_FIELD_LABELS.colorScheme,
    );
