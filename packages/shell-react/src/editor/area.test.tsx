...
describe('EditorArea', () => {
  ...
  it('keeps plain JSON code-only without form/preview toolbar', async () => {
    ...
    expect(
      container.querySelector('.ui-editor-tabs__addons [data-testid="editor-view-mode-select"]'),
    ).toBeNull();
  ...
  it('renders preview controls for JDW JSON workspace files', async () => {
    ...
    await waitForSelector(
      container,
      '.ui-editor-tabs__addons [data-testid="editor-view-mode-select"]',
    );
    ...
    expect(
      container.querySelector(
        '.workbench-editor-area__text-editor > [data-testid="editor-view-mode-select"]',
      ),
    ).toBeNull();
    expect(
      container.querySelector('.ui-editor-tabs__addons button[aria-label="Code"][title="Code"]'),
    ).not.toBeNull();
    expect(
    ...
    // Form-eligible JDW docs open in Form by default (exclusive view mode).
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Form"][aria-checked="true"]',
      ),
    ).not.toBeNull();
  ...
  it('renders Markdown preview beside source and supports preview-only mode', async () => {
    ...
    // Exclusive view mode: Preview replaces Code (no side-by-side split).
    expect(container.querySelector('.ui-workbench-split-view')).toBeNull();
    ...
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Preview"][aria-checked="true"]',
      ),
    ).not.toBeNull();
    ...
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Code"][aria-checked="true"]',
      ),
    ).not.toBeNull();
  ...
  it('renders JDW preview beside code and form panes from the shared source content', async () => {
    ...
    // Form-eligible JDW defaults to Form (no monaco until Code is selected).
    expect(container.querySelector('.ui-workbench-split-view')).toBeNull();
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Form"][aria-checked="true"]',
    ...
    expect(container.querySelector('.workspace-editor__monaco')).toBeNull();
    expect(container.querySelector('[data-testid="widget-tree-lab"]')).not.toBeNull();
    ...
    await waitForSelector(container, '.workspace-editor__monaco');
    expect(container.querySelector('[data-testid="widget-tree-lab"]')).toBeNull();
    ...
    expect(container.querySelector('.workspace-editor__monaco')).toBeNull();
    const formLab = container.querySelector('[data-testid="widget-tree-lab"]');
    expect(formLab).not.toBeNull();
    expect(formLab?.getAttribute('data-show-design-source')).toBe('false');
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Form"][aria-checked="true"]',
      ),
  ...
  it('can open matching resources directly in preview mode', async () => {
    ...
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Code"][aria-checked="false"]',
      ),
    ).not.toBeNull();
  ...
  it('keeps the selected view mode when editing a default-preview resource', async () => {
    ...
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Preview"][aria-checked="false"]',
      ),
    ).not.toBeNull();
    ...
    // Editing keeps Code selected (does not bounce back to default Preview).
    expect(
      container.querySelector(
        '.ui-editor-tabs__addons button[aria-label="Code"][aria-checked="true"]',
      ),
