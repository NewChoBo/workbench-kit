...
describe('builtin.editor markdown provider wiring through WorkbenchProvider', () => {
  it('exposes markdown preview provider after startup', async () => {
    function Probe() {
    ...
    expect(payload.providers).toEqual(['workbench-kit.builtin.editor.markdown-preview']);
