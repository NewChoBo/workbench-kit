...
describe('WidgetTreeLab', () => {
  it('renders source, tree, and preview surfaces', () => {
    ...
    expect(markup).toContain('data-testid="widget-tree-lab-assets-sidebar"');
    expect(markup).toContain('data-testid="widget-tree-lab-main-pane"');
    expect(markup).toContain('data-testid="widget-tree-lab-authoring-sidebar"');
    ...
    expect(markup).toContain('aria-label="Widget assets"');
  ...
  it('resolves preview values for listen bindings in the canvas preview', () => {
    const markup = renderToStaticMarkup(
      <WidgetTreeLab
        previewValues={{ title: 'Resolved title' }}
        registry={WIDGET_TREE_DEMO_REGISTRY}
    ...
    expect(markup).toContain('Resolved title');
    expect(markup).toContain('data-testid="jdw-preview-output"');
  });
