...
const defaultSelectionByActivity = integratedShellDefaultSelectionByActivity;

const workspaceFolders = [...integratedShellWorkspaceFolders];

const workspaceFiles = integratedShellWorkspaceFiles;

const initialRuntimeMessages = integratedShellInitialRuntimeMessages;
