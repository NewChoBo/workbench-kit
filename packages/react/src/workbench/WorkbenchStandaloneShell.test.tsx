...
describe('WorkbenchStandaloneShell activity bar utilities', () => {
  afterEach(() => {
    document.body.innerHTML = '';
  });

  it('places Help before Settings in the activity bar footer', async () => {
    ...
    expect(buttons.indexOf(helpButton!)).toBeLessThan(buttons.indexOf(settingsButton!));

    await act(async () => {
      helpButton?.click();
    });
    expect(helpActivated).toBe(true);
