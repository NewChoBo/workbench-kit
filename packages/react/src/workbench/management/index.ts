...
export {
  ...
  type LibraryCatalogPickerDialogLabels,
  type LibraryCatalogPickerDialogProps,
  type LibraryCatalogPickerItem,
} from './LibraryCatalogPickerDialog.js';
export {
  LibraryFacetFilterDialog,
  type LibraryFacetFilterDialogProps,
} from './LibraryFacetFilterDialog.js';
export {
