...
describe('WorkbenchViewSidebar', () => {
  it('renders view items with active state, item data attributes, and icons', () => {
    ...
    expect(markup).toContain('workbench-primary-sidebar');
    ...
    expect(markup).toContain('ui-sidebar-list-item--active');
    expect(markup).toContain('ui-sidebar-list-item--selected');
