...
> {
  ...
  readonly metadata?:
    ((definition: TDefinition) => Record<string, unknown> | undefined) | undefined;
  readonly options?:
    ((definition: TDefinition) => readonly WorkbenchSchemaFormOption[] | undefined) | undefined;
  readonly type?:
    ((definition: TDefinition) => WorkbenchSchemaFormSettingValueType | undefined) | undefined;
}
