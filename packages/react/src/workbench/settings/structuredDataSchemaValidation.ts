...
import {
  isWorkbenchStructuredDataSchemaDateField,
...
export const SCHEMA_FIELD_DATE_WARNING = 'Value is not a valid date.';
...
export function validateWorkbenchStructuredDataSchemaFieldValue(
  ...
  if (isWorkbenchStructuredDataSchemaDateField(definition)) {
    if (trimmed === '') return undefined;
    if (!parseWorkbenchStructuredDataSchemaDateValue(trimmed, definition)) {
      return SCHEMA_FIELD_DATE_WARNING;
    }
  }
