...
interface UseModalDragOptions {
  ...
  viewport: ModalContainerBounds;
}

export function useModalDrag({ bounds, maximized, setBounds, viewport }: UseModalDragOptions) {
  ...
  }, [dragging, setBounds, stopDragging, viewport]);
