...
영어 README가 canonical 문서입니다. 이 문서는 한국어 companion 번역입니다.
...
- 공개 문서, 커밋 메시지, release note, changelog, package metadata는 영어를 canonical로 둡니다.
- 한국어 문서는 로컬 온보딩을 위한 companion 번역으로 제공합니다.
- 영어 문서와 한국어 문서가 어긋나면 영어 문서를 먼저 수정하고 한국어 companion을 갱신합니다.
...
- [한국어 Conventions](./docs/ko/conventions/README.md)
